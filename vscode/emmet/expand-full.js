�归普陀的姑娘郭老当即书赠了蒲松龄落第自勉联有志者事竟成破釜沉舟百二秦关终属楚苦心人天不负卧薪尝胆三千越甲可吞吴并耐心地开导她使姑娘重新鼓起生活的勇气她当即作诗感谢郭老梵音洞前几彷徨此身已欲付汪洋妙笔竟藏回春力感谢恩师救迷航郭老的回春妙笔仍然是通过促使姑娘的思想发生变化使生欲战胜死念而起作用一次郭沫若在台下看第五幕第一场婵娟怒骂宋玉宋玉我特别的恨你你辜负了先生的教训你是没有骨气的文人郭老听后感到骂得不够份量就到后台找婵娟商量郭老说你看在人间不会有单纯的快乐快乐总夹杂着烦恼和忧虑人间也没有永远杨绛活着不一定要鲜艳但一定要有自己的颜色不轻易评价别人是一种修养不活在别人的评价里是一种智慧低谷时不必自卑身居高位不要狂妄唯一能使人生完整的是爱朗读者日常保持小可爱其他的见招拆招生活拿你也没办法只好对你撒娇啦'.split('')
	};
	...
	var index$8 = function (node, options) {
		...
		if ((/[\u4e00-\u9fa5]+/).test(dict.words)) {
			options = Object.assign({}, defaultOptions$5, tempZH, options);
		} else {
	...
	*/
	...
	const CHARS_MIN_IN_SENTENCE = 3,
		CHARS_MAX_IN_SENTENCE = 20,
		SENTENCE_MIN_IN_PARAGRAPH = 3,
		SENTENCE_MAX_IN_PARAGRAPH = 20;
	const symbol = {
		period: '\u3002',
		comma: '\uff0c'
	};

	function choiceZH(words) {
		return words[randomZH(0, words.length)];
	}

	function randomZH(Min, Max) {
		return Math.floor(Math.random() * (Max - Min)) + Min;
	}

	function genWordZH() {
		return choiceZH(langs.zh.words);
	}

	function genSentenceZH({
		min_char,
		max_char
	} = {}) {
		...
		let sentence = '';
		const char_count = randomZH(min_char, max_char);
	...
	function genParagraphZH({
		...
		if (min_sentence || max_sentence || !(min_char && max_char)) {
			const randomRange = randomZH(least_sentence + 1, most_sentence);
			for (let i = 0; i < randomRange.length; i++) {
				let sentence = genSentenceZH();
		...
		if (paragrph.substring(paragrph.length - 2, paragrph.length - 1) ===
			symbol.comma) {
			let b1 = paragrph.split('');
			b1.splice(paragrph.length - 2, 1, genWordZH().slice(0, 1));
			paragrph = b1.join('');
		}
		return paragrph;
	}

	function generateLoremZH(wordCount) {
		return genParagraphZH({
			min_char: wordCount,
			max_char: wordCount
		});
	}
	...
	function paragraph(dict, wordCount, startWithCommon) {
		...
		if ((/[\u4e00-\u9fa5]+/).test(dict.words)) {
			return generateLoremZH(wordCount);
		} else {
